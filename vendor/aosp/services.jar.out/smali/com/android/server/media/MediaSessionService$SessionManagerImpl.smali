...
.method private handleVoiceKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    .line 858
    invoke-direct {p0, p2}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->startVoiceInputEx(Z)V
...
.method private startVoiceInputEx(Z)V
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mMediaEventWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v8}, Lcom/android/server/media/MediaSessionService;->access$2700(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
    ...
    const-string v8, "com.lge.action.START_QVOICE"
    ...
    invoke-interface {v4, v7, v8, v9, v5}, Landroid/content/pm/IPackageManager;->resolveIntent(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ResolveInfo;
    ...
    const-string v10, "voice-based interactions: resolveIntent = "
    ...
    const-string v9, "voice-based interactions: about to use ACTION_START_QVOICE"
    ...
    const-string v9, "Dead resolveIntent"
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mMediaEventWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v9}, Lcom/android/server/media/MediaSessionService;->access$2700(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
...
.method public dispatchMediaKeyEvent(Landroid/view/KeyEvent;Z)V
    ...
    const-string v8, "dispatchMediaKeyEvent keyEvent:"
