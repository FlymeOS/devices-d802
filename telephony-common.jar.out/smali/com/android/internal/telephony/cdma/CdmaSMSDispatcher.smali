...
.method handleCdmaReadReceiptReport(Lcom/android/internal/telephony/cdma/SmsMessage;)V
    .locals 8
    ...
    .local v3, "i":I
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->readReceiptPendingList:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, v6, v7}, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->updateSentMessageReadReceipt(Landroid/content/Context;I)V

    .line 167
    iget-object v4, v5, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->mReadReceiptIntent:Landroid/app/PendingIntent;
    ...
    const-string v6, "handleCdmaReadReceiptReport CanceledException()"
...
.method protected handleReadReceiptReport(Ljava/lang/Object;)V
    ...
    .line 152
    const-string v0, "calling handleReadReceiptReport()"
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->handleCdmaReadReceiptReport(Lcom/android/internal/telephony/cdma/SmsMessage;)V
    ...
    const-string v1, "handleReadReceiptReport() called for object type "
...
.method sendReadReceiptReportMessage(Lcom/android/internal/telephony/cdma/SmsMessage;)V
    .locals 1
    .param p1, "sms"    # Lcom/android/internal/telephony/cdma/SmsMessage;

    .prologue
    .line 145
    const-string v0, "sending EVENT_HANDLE_READ_RECEIPT_REPORT message"
