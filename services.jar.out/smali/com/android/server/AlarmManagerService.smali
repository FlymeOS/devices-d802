...
.field static final EPSM_DEBUG:Z = false
...
.method private findFirstWakeupBatchLocked()Lcom/android/server/AlarmManagerService$Batch;
    ...
    .prologue
    .line 1409
    invoke-direct {p0}, Lcom/android/server/AlarmManagerService;->getAlarmDeterrence()Z

    move-result v1

    .line 1411
    .local v1, "alarmDeterrence":Z
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/AlarmManagerService$Batch;->hasWakeups(Z)Z
    ...
    .line 1412
    .restart local v2    # "b":Lcom/android/server/AlarmManagerService$Batch;
    :cond_0
...
.method private getAlarmDeterrence()Z
    .locals 6
...
.method private setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
    ...
    invoke-direct/range {v0 .. v25}, Lcom/android/server/AlarmManagerService;->setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;IJJIIJ)V
...
.method rebatchAllAlarmsLocked(Z)V
    ...
    iget-boolean v6, v0, Lcom/android/server/AlarmManagerService;->mDataSchedulerEnabled:Z
...
.method setImpl(IJJJLandroid/app/PendingIntent;ZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;)V
    ...
    iget-boolean v7, v0, Lcom/android/server/AlarmManagerService;->mDataSchedulerEnabled:Z
    ...
    invoke-direct/range {v22 .. v39}, Lcom/android/server/AlarmManagerService;->setImplLocked(IJJJJJLandroid/app/PendingIntent;ZZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
...
.method triggerAlarmsLocked(Ljava/util/ArrayList;JJ)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/AlarmManagerService;->getAlarmDeterrence()Z

    move-result v34

    .line 1831
    .local v34, "alarmDeterrence":Z
    :cond_0
    move-object/from16 v0, p0
    ...
    iget-object v2, v0, Lcom/android/server/AlarmManagerService$Batch;->mAlarmWhiteList:Ljava/util/List;
    ...
    .line 1877
    .local v42, "policy":Landroid/net/DataSchedulerPolicy;
    if-eqz v42, :cond_d
    ...
    .line 1915
    .end local v42    # "policy":Landroid/net/DataSchedulerPolicy;
    :cond_4
    :goto_3
    move-object/from16 v0, p0

    iget-boolean v2, v0, Lcom/android/server/AlarmManagerService;->mDataSchedulerEnabled:Z
    ...
    .restart local v42    # "policy":Landroid/net/DataSchedulerPolicy;
    .restart local v44    # "triggerAtTime":J
    :cond_9
    move-object/from16 v0, v42
