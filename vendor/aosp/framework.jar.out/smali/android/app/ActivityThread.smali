...
.field static sBroadcastIntentWhiteList:Ljava/util/List;
...
.field static sBroadcastPakageBlackList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method static constructor <clinit>()V
    ...
    const-string v1, "com.nttdocomo.android.atf"
    ...
    sput-object v0, Landroid/app/ActivityThread;->sBroadcastPakageBlackList:Ljava/util/List;
    ...
    sput-object v0, Landroid/app/ActivityThread;->sBroadcastIntentWhiteList:Ljava/util/List;
...
.method private handleReceiver(Landroid/app/ActivityThread$ReceiverData;)V
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/content/Intent;->prepareToEnterProcess()V
    ...
    invoke-virtual {v13, v0, v1}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;

    move-result-object v4

    .line 2606
    .local v4, "app":Landroid/app/Application;
    sget-boolean v17, Lcom/lge/config/ThreelmMdmConfig;->THREELM_MDM:Z

    if-eqz v17, :cond_2

    .line 2607
    const-string v17, "PowerSaving3LM"
    ...
    invoke-static {v5}, Landroid/os/IPowerSaving3LMService$Stub;->asInterface(Landroid/os/IBinder;)Landroid/os/IPowerSaving3LMService;

    move-result-object v16

    .line 2609
    .local v16, "service":Landroid/os/IPowerSaving3LMService;
    if-eqz v16, :cond_2
    ...
    invoke-interface/range {v16 .. v17}, Landroid/os/IPowerSaving3LMService;->isPackageDisabledWhilePowerSaving(Ljava/lang/String;)Z
    ...
    const-string v19, "Power_saving denies receive of "
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/content/ComponentName;->toShortString()Ljava/lang/String;
    ...
    invoke-virtual {v13}, Landroid/app/LoadedApk;->getAppDir()Ljava/lang/String;
    ...
    .end local v16    # "service":Landroid/os/IPowerSaving3LMService;
    :catch_0
    move-exception v9
    ...
    const-string/jumbo v17, "ro.build.target_operator"
    ...
    .line 2623
    const-string/jumbo v17, "persist.sys.epsmodestate"
    ...
    .line 2624
    .local v10, "epsmodestatus":Z
    const-string/jumbo v17, "power"

    move-object/from16 v0, v17

    invoke-virtual {v8, v0}, Landroid/app/ContextImpl;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 2629
    .local v11, "isScreenOn":Z
    if-nez v11, :cond_4

    if-eqz v10, :cond_4

    .line 2630
    sget-object v17, Landroid/app/ActivityThread;->sBroadcastPakageBlackList:Ljava/util/List;
    ...
    .line 2631
    const-string/jumbo v3, "null(intent_without_action)"
    ...
    .line 2635
    :cond_3
    sget-object v17, Landroid/app/ActivityThread;->sBroadcastIntentWhiteList:Ljava/util/List;
    ...
    .end local v10    # "epsmodestatus":Z
    .end local v11    # "isScreenOn":Z
    ...
    invoke-virtual {v0, v15, v9}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
