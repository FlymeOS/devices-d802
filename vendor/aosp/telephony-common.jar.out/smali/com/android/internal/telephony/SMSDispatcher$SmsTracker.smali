...
.field public final mReadReceiptIntent:Landroid/app/PendingIntent;
...
.method private constructor <init>(Ljava/util/HashMap;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/content/pm/PackageInfo;Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicInteger;Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/net/Uri;Lcom/android/internal/telephony/SmsHeader;ZI)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->mReadReceiptIntent:Landroid/app/PendingIntent;
...
.method private constructor <init>(Ljava/util/HashMap;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/content/pm/PackageInfo;Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicInteger;Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/net/Uri;Lcom/android/internal/telephony/SmsHeader;ZILandroid/app/PendingIntent;)V
    ...
    .param p11, "isExpectMore"    # Z
    .param p12, "validityPeriod"    # I
    .param p13, "readReceiptIntent"    # Landroid/app/PendingIntent;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/HashMap",
    ...
    .line 1252
    iput-object p13, p0, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->mReadReceiptIntent:Landroid/app/PendingIntent;
...
.method synthetic constructor <init>(Ljava/util/HashMap;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/content/pm/PackageInfo;Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicInteger;Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/net/Uri;Lcom/android/internal/telephony/SmsHeader;ZILandroid/app/PendingIntent;Lcom/android/internal/telephony/SMSDispatcher$1;)V
    ...
    .param p11, "x10"    # Z
    .param p12, "x11"    # I
    .param p13, "x12"    # Landroid/app/PendingIntent;
    .param p14, "x13"    # Lcom/android/internal/telephony/SMSDispatcher$1;
...
.method public updateSentMessageReadReceipt(Landroid/content/Context;I)V
    .locals 6
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "status"    # I
